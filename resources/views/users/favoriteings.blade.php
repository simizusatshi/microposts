    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <ul class="nav nav-tabs nav-justified mb-3">
                ...
                <li class="nav-item"><a href="{{ route('users.favoriteings', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/favoriteings') ? 'active' : '' }}">Favoriteings <span class="badge badge-secondary">{{ $count_favoriteings }}</span></a></li>
            </ul>
